...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'GreenEx-dev'),
...
|
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_all_orders,read_assigned_fulfillment_orders,write_assigned_fulfillment_orders,read_fulfillments,write_fulfillments,read_merchant_managed_fulfillment_orders,write_merchant_managed_fulfillment_orders,read_orders,write_orders'),
    ...
    */
    ...
    'listen' => [
        \Osiset\ShopifyApp\Messaging\Events\AppInstalledEvent::class => [
            // \App\Providers\AppInstalledListener::class,
